...
function FriendsPage() {
  ...
  const fetchData = useCallback(async () => {
    try {
      const [friendsRes, pendingRes] = await Promise.all([
        axios.get(`https://peoplegrid-api.onrender.com/api/friends/list`, getAuthHeaders()),
        axios.get(`https://peoplegrid-api.onrender.com/api/friends/pending`, getAuthHeaders())
      ]);
  ...
  const handleSearch = async () => {
    ...
    try {
      const res = await axios.get(`https://peoplegrid-api.onrender.com/api/friends/search?query=${searchQuery}`, getAuthHeaders());
  ...
  const sendFriendRequest = async (recipientId) => {
    try {
      await axios.post(`https://peoplegrid-api.onrender.com/api/friends/request/${recipientId}`, {}, getAuthHeaders());
  ...
  const acceptFriendRequest = async (requesterId) => {
    try {
      await axios.put(`https://peoplegrid-api.onrender.com/api/friends/accept/${requesterId}`, {}, getAuthHeaders());
